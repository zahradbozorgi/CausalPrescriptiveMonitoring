...
def load_realcause_dataset(dataset, sample=0):
    valid_datasets = {'lalonde_cps', 'lalonde_psid', 'twins', 'bpic17'}
...
def load_from_folder(dataset, checkpoint_path="../GenModelCkpts"):
    ...
    subdatasets = listdir_nohidden(checkpoint_dir / dataset_stem)
    ...
    #subfolders = ['/home/zdashtbozorg/realcause/GenModelCkpts_myModel/bpic17/bpic17/bpic17']
